# YOLOv4-RepVGG-RCSOSA 架构图

**描述**: RepVGG卷积 + RCS-OSA模块 + IDetect检测头
...
flowchart TD
    ...
    title["YOLOv4-RepVGG-RCSOSA<br/>RepVGG卷积 + RCS-OSA模块 + IDetect检测头"]
...
```bash
python train.py \
  --cfg cfg/training/yolov4-repvgg-rcsosa.yaml \
